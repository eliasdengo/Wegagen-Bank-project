            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-5">
              <div class="card bg-dark text-white" style="border-radius: 1rem;">
                <div class="card-body p-5 text-center">
                    <form action="remittancelinks.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-md-5 mt-md-4 pb-5">
                      ...
                      <div class="mb-3">
                          ...
                          <input type="url" class="form-control" name="link" id="link" placeholder="https://www.wegagen.com">
                        </div>
                        <div class="mb-3">
