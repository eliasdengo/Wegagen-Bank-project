...
require_once 'conn.php';
  ...
  $id=$_GET['edit'];
 $sql="select * from remittancelink where id=$id";
...
$target_file = $parent."./assets/img/"  . basename($_FILES["icon"]["name"]);
  ...
  $sql="update `remittancelink` set id=$id,icon_dir='$icon',title='$title',link='$link' where id=$id";
...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1><img title="locallink" alt="Wegagen Bank" src="../assets/img/cropped-cropped-cropped-cropped-wegagen-bank-1.png" width="120px"/></a></h1>
        <!-- Uncomment below if you prefer to use an image logo -->
        <!-- <a href="index.html"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>-->
      </div>
      <nav id="navbar" class="navbar">
        <ul>
        <li><a class="nav-link scrollto " href="locallinks.html">Local Links</a></li>
        <li><a class="nav-link scrollto "  href="remittancelinks.html">Remittance Links</a></li>
        </ul>
                ...
                <div class="card-body p-5 text-center">
                    <form action="#" method="post" enctype="multipart/form-data">
                        <div class="input-group mb-3">
                            <label style="color:#ff660f;">Remittance Links</label>
                    ...
                    <div class="mb-md-5 mt-md-4 pb-5">
                      ...
                      <div class="mb-3">
                          ...
                          <input type="url" class="form-control" name="link" value="<?php echo $link; ?>" id="link" placeholder="https://www.wegagen.com">
                        </div>
                        <div class="mb-3">
